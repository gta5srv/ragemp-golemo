    ...
    class Customization : Script
    {
        ...
        */
        ...
        public static void SendBackToWorld(Player player)
        {
            ...
            Vector3 pos = new Vector3(-1036.3226, -2732.918, 12.766636);
        ...
        public void ClientEvent_saveCharacter(Player player, params object[] args)
        {
            try
            {
                ...
                if (!isChanging)
                {
                    ...
                    if (!Main.Accounts[player].PresentGet && Main.Accounts[player].PromoCodes[0].Equals("golemo"))
                    {
                        Main.Accounts[player].PresentGet = true;
                        GameLog.Money($"server", $"player({Main.Players[player].UUID})", 7500, $"golemo");
