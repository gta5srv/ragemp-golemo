    ...
    class Doormanager : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                //Pacific Standard Bank Exit Doors
                NAPI.World.DeleteWorldProp(110411286, new Vector3(260.6518, 203.2292, 106.4328), 2f);
                NAPI.World.DeleteWorldProp(110411286, new Vector3(260.6518, 203.2292, 106.4328), 2f);

                //Pacific Standard Bank Back To Hall Doors
                NAPI.World.DeleteWorldProp(110411286, new Vector3(259.9831, 215.2468, 106.4049), 2f);
                NAPI.World.DeleteWorldProp(110411286, new Vector3(259.0879, 212.8062, 106.4049), 2f);
                ...
                //ClothShop
                NAPI.World.DeleteWorldProp(-1148826190, new Vector3(82.38156, -1390.476, 29.52609), 30f);   //open
                NAPI.World.DeleteWorldProp(868499217, new Vector3(82.38156, -1390.752, 29.52609), 30f);     //open
