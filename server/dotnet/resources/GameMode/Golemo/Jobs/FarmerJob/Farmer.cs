    ...
    public class Farmer : Script
    {
        ...
        public void Event_FarmerStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(677, new Vector3(438.3554, 6510.949, 27.49061), 1, 24, "Ферма", 255, 0, true, 0, 0); // Блип на карте
                NAPI.TextLabel.CreateTextLabel("~g~Фермер Голем", new Vector3(438.3554, 6510.949, 29.6), 10f, 0.1f, 4, new Color(255, 255, 255), true, NAPI.GlobalDimension); // Над головой у Ped
